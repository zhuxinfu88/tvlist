...
keywords = ['CCTV','CCTV欧','CCTV美','CETV','CGTN','新闻综合','东方影视','都市剧场','东方财经','第一财经','纪实人文','上海外语','生活时尚','极速汽车','浙江钱江','浙江生活','浙江教育','浙江民生','浙江新闻','浙江少儿','浙江纪录','杭州综合','杭州明珠''杭州生活''CF''CF''CF''CF', 'IPT淘', 'CHC', 'IWA', '凤凰卫视', '星空', 'CHANNEL', 'W','卫视', 'X','Y']  #enter
